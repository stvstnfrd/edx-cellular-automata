...
Brought over from @jbau's repo into here until a more generalized mixin is supported.  Only
thing changed is the display_name
"""
...
class LmsCompatibilityMixin(object):
    ...
    display_name = String(
        default="OLI Automata", scope=Scope.settings,
        help="Display name"
    )
